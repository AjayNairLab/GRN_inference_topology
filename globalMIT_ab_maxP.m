...
%Specifically this code is implementation of 'maxP' algorithm.
%maxP algorithm ensures that the number of parents for a node are
%limited to the user input variable 'maxParent' 

%Usage:
% [best_net,numParentsChecked]=globalMIT_ab_maxP(a,b,alpha,allowSelfLoop,maxParent)
% Input:
...
function [best_net,numParentsChecked]=globalMIT_ab_maxP(a,b,alpha,allowSelfLoop,maxParent)
